...
For more deployment options, join our [Discord Server](https://discord.gg/interstellar) for various ways to deploy Watermath.
...
> [!NOTE]
> We are committed to making Watermath easy and personalized however, as of now we need your support in making it ad-free. Consider keeping ads so Watermath can run freely or contribute by being a supporter.
...
A huge thanks goes out to all of the people who have contributed to Watermath.
